...
export const modalContent = {
  ...
  csstricks: {
    ...
    linkText: "Visit CSS-Tricks",
    paragraphs: [
      "CSS-Tricks is a website dedicated to teaching all things web design and development, with a strong focus on CSS techniques.",
      "Founded by Chris Coyier, it has become one of the most trusted resources for front-end developers looking to improve their skills and knowledge.",
      "The site features articles, guides, snippets, and videos covering everything from basic CSS concepts to advanced layouts and animations.",
      "CSS-Tricks also covers related topics like JavaScript, SVG, and modern workflow tools that complement CSS work.",
    ],
  },
  threejsjourney: {
    title: "Three.js Journey",
    link: "https://threejs-journey.com",
    linkText: "Explore Three.js Journey",
    paragraphs: [
  ...
  threejs: {
    ...
    paragraphs: [
      ...
      "Created by Ricardo Cabello (Mr.doob), Three.js simplifies the process of working with WebGL by providing a higher-level API that abstracts away many of the complexities.",
      "The library includes a wide range of features including scenes, cameras, renderers, lights, materials, geometries, and more.",
      "Three.js has become the standard for 3D web development and is used by companies like Google, Adobe, and Microsoft for creating interactive 3D experiences on the web.",
    ],
  },
};
